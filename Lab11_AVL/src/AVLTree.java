public class AVLTree {
	...
	public void makeAVL() throws Exception {
		...
		AVLTreeIterator itr1 = (AVLTreeIterator) findMin(this.root);
		while(itr1.hasNext()) {
			newTree.insert(itr1.currentNode.data);
			itr1.next();
		}
	...
	public boolean isAVL() {
		...
		AVLTree subtreeright = new AVLTree();
			if(this.root == null) {
				...
				return (AVLNode.tiltDegree(this.root) <= 1 && AVLNode.tiltDegree(this.root)>= -1 ) &&  (subtreeleft.isAVL() && subtreeright.isAVL());
	...
	public static boolean same(AVLTree t1, AVLTree t2) {
		//code this method
		AVLTree subtreeleft1 = new AVLTree();
		AVLTree subtreeleft2 = new AVLTree();
		AVLTree subtreeright1 = new AVLTree();
		AVLTree subtreeright2 = new AVLTree();
		...
		if(t1.root.data != t2.root.data) {
			...
			subtreeleft1.root = t1.root.left;
			subtreeleft2.root = t2.root.left;
			subtreeright1.root = t1.root.right;
			subtreeright2.root = t2.root.right;		
		return (same(subtreeleft1, subtreeleft2) && same(subtreeright1, subtreeright2));
	}
